...
typedef void (lm_evaluate_ftype) (double *par, int m_dat, double *fvec, double *err,
				  void *data, int *info);
// default implementation therof, provided by lm_eval.c:
void lm_evaluate_default(double *par, int m_dat, double *fvec, double *err, void *data,
			 int *info);
